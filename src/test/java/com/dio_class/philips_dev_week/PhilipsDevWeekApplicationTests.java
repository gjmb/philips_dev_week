package com.dio_class.philips_dev_week;

import com.dio_class.philips_dev_week.Controller.ControllerRegiao;
...
class PhilipsDevWeekApplicationTests {
	...
	//lista o objeto solicitado por id
	@Test
	...
	public void addNewRegiaoTest() throws Exception{
		Regiao newRegiao = new Regiao(89L,"Noroeste", 47);
		mockMvc.perform(post(URL+"/novo").
				contentType(MediaType.APPLICATION_JSON).content(asJsonString(newRegiao))).
